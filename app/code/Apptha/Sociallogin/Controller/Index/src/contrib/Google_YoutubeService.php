...
class Google_ChannelsServiceResource extends Google_ServiceResource {
     ...
     * Either the 'id' or 'mine' parameter must be set.
     * (channels.list)
     *
     * @param string $part
     *            Parts of the channel resource to be returned.
...
class Google_PlaylistitemsServiceResource extends Google_ServiceResource {
     ...
     *
     * @param string $part
     *            Parts of the playlist resource to be returned.
     * @param array $optParams
     *            Optional parameters.
     *            
...
class Google_PlaylistsServiceResource extends Google_ServiceResource {
     ...
     *
     * @param string $id
     *            YouTube IDs of the playlists to be returned.
     * @param string $part
     *            Parts of the playlist resource to be returned.
     * @param array $optParams
     *            Optional parameters.
...
class Google_VideosServiceResource extends Google_ServiceResource {
     ...
     *
     * @param string $id
     *            YouTube IDs of the videos to be returned.
     * @param string $part
     *            Parts of the video resource to be returned.
     * @param array $optParams
     *            Optional parameters.
