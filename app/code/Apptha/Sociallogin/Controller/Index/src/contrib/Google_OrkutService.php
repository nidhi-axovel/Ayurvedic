...
class Google_CommunityMembersServiceResource extends Google_ServiceResource {
     ...
     * Use the pagination tokens to retrieve the full list; do not rely on
...
class Google_ActivitiesServiceResource extends Google_ServiceResource {
     ...
     *
     * @param string $userId
     *            The ID of the user whose activities will be listed. Can be me to refer to the viewer (i.e. the authenticated user).
...
class Google_CommunitiesServiceResource extends Google_ServiceResource {
     ...
     * profile) of a community. (communities.get)
     *
     * @param int $communityId
