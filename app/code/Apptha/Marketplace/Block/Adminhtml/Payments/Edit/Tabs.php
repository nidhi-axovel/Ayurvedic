...
class Tabs extends WidgetTabs {
    ...
    $this->addTab ( 'Payments', ['label' => __ ( 'Pay Seller Payments' ),'title' => __ ( 'Seller Payments' ),'content' => $this->getLayout ()->createBlock ( 'Apptha\Marketplace\Block\Adminhtml\Payments\Edit\Tab\Form' )->toHtml (),'active' => true] );
